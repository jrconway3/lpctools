...
animations = {
	...
	'backslash': Animation.make_directions('backslash',13),
...
layouts = {
	...
	'universal-expanded': SpritesheetLayout.from_rows([
			...
			[ ('run'        , 's' , range(8)) ] ,
			[ ('run'        , 'e' , range(8)) ] ,
			[ ('combat_idle', 'n' , range(2)) ] ,
			[ ('combat_idle', 'w' , range(2)) ] ,
			[ ('combat_idle', 's' , range(2)) ] ,
			[ ('combat_idle', 'e' , range(2)) ] ,
			[ ('backslash'  , 'n' , range(13)) ] ,
			[ ('backslash'  , 'w' , range(13)) ] ,
			[ ('backslash'  , 's' , range(13)) ] ,
			[ ('backslash'  , 'e' , range(13)) ] ,
			[ ('halfslash'  , 'n' , range(6)) ] ,
			[ ('halfslash'  , 'w' , range(6)) ] ,
			[ ('halfslash'  , 's' , range(6)) ] ,
			[ ('halfslash'  , 'e' , range(6)) ]
	...
	'emote': SpritesheetLayout.from_animation('emote',3),
	'combat_idle': SpritesheetLayout.from_animation('combat_idle',2),
	'backslash': SpritesheetLayout.from_animation('backslash',13),
