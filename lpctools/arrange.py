...
layouts = {
	...
	'universal-expanded': SpritesheetLayout.from_rows([
			...
			[ ('run-r'      , 's' , range(8)) ] ,
			[ ('run-r'      , 'e' , range(8)) ] ,
			[ ('idle-combat', 'n' , range(2)) ] ,
			[ ('idle-combat', 'w' , range(2)) ] ,
			[ ('idle-combat', 's' , range(2)) ] ,
			[ ('idle-combat', 'e' , range(2)) ] ,
			[ ('backslash-u', 'n' , range(13)) ] ,
			[ ('backslash-u', 'w' , range(13)) ] ,
			[ ('backslash-u', 's' , range(13)) ] ,
			[ ('backslash-u', 'e' , range(13)) ] ,
			[ ('halfslash'  , 'n' , range(6)) ] ,
			[ ('halfslash'  , 'w' , range(6)) ] ,
			[ ('halfslash'  , 's' , range(6)) ] ,
			[ ('halfslash'  , 'e' , range(6)) ]
	...
	'climb': SpritesheetLayout.from_animation('climb',6,['n']),
	'emote': SpritesheetLayout.from_rows([
			[('emote', 'n', 2), ('surprised' , 'n' , 0)],
			[('emote', 'w', 2), ('surprised' , 'w' , 0)],
			[('emote', 's', 2), ('surprised' , 's' , 0)],
			[('emote', 'e', 2), ('surprised' , 'e' , 0)],
		]),
