...
animations = {
	...
	'carry': Animation.make_directions('carry',9),
	'climb': Animation.make_directions('climb',6,['n']),
	...
	'emotes': Animation.make_directions('emotes',3),
	'idle-combat': Animation.make_directions('idle-combat',2),
	'slash-r': Animation.make_directions('backslash',7),
	'backslash': Animation.make_directions('backslash',12),
	'backslash-u': Animation.make_directions('backslash-u',13),
	'halfslash': Animation.make_directions('halfslash',6),
}
...
layouts = {
	...
	'universal-expanded': SpritesheetLayout.from_rows([
			...
			[ ('hurt'      , 's' , range(6)) ] ,
			[ ('climb'     , 'n' , range(6)) ] ,
			[ ('idle'      , 'n' , range(2)), ('idle-combat'      , 'n' , range(2)) ] ,
			[ ('idle'      , 'w' , range(2)), ('idle-combat'      , 'w' , range(2)) ] ,
			[ ('idle'      , 's' , range(2)), ('idle-combat'      , 's' , range(2)) ],
			[ ('idle'      , 'e' , range(2)), ('idle-combat'      , 'e' , range(2)) ],
			[ ('jump'      , 'n' , range(5)) ] ,
			[ ('jump'      , 'w' , range(5)) ] ,
			[ ('jump'      , 's' , range(5)) ] ,
			[ ('jump'      , 'e' , range(5)) ] ,
			[ ('sit'       , 'n' , range(3)), ('emotes'      , 'n' , range(3)) ] ,
			[ ('sit'       , 'w' , range(3)), ('emotes'      , 'n' , range(3)) ] ,
			[ ('sit'       , 's' , range(3)), ('emotes'      , 'n' , range(3)) ] ,
			[ ('sit'       , 'e' , range(3)), ('emotes'      , 'n' , range(3)) ] ,
			[ ('run-r'     , 'n' , range(8)) ] ,
			[ ('run-r'     , 'w' , range(8)) ] ,
			[ ('run-r'     , 's' , range(8)) ] ,
			[ ('run-r'     , 'e' , range(8)) ] ,
	...
	'run-r': SpritesheetLayout.from_animation('run-r',8),
	'climb': SpritesheetLayout.from_animation('climb',6),
	'emotes': SpritesheetLayout.from_rows([
			[('emotes', 'n', 2), ('surprised' , 'n' , 0)],
			[('emotes', 'w', 2), ('surprised' , 'w' , 0)],
			[('emotes', 's', 2), ('surprised' , 's' , 0)],
			[('emotes', 'e', 2), ('surprised' , 'e' , 0)],
		]),
	'idle-combat': SpritesheetLayout.from_animation('idle-combat',2),
	'slash-r': SpritesheetLayout.from_animation('slash-r',7),
	'backslash': SpritesheetLayout.from_animation('backslash',12),
	'halfslash': SpritesheetLayout.from_animation('halfslash',6),
